...
async function bootstrapDb(sql: any) {
  try {
    ...
    await sql`
      CREATE UNIQUE INDEX IF NOT EXISTS spiritual_journey_day_uq ON spiritual_journey_days ("journeyId", "dayNumber");
    `;
    ...
    await sql`
      CREATE UNIQUE INDEX IF NOT EXISTS spiritual_journey_progress_user_uq ON spiritual_journey_progress ("userId", "journeyId");
    `;
    ...
    await sql`
      CREATE UNIQUE INDEX IF NOT EXISTS spiritual_journey_journal_user_day_uq ON spiritual_journey_journals ("userId", "journeyId", "dayNumber");
    `;
