...
const exploreCards: ExploreCard[] = [
  ...
  { href: "/pilulas", label: "Pílulas de Sabedoria", desc: "Retiro espiritual em 10 dias", image: "/assets/dashboard/lectio.webp", overlay: "oklch(0.35 0.10 40 / 0.60)", category: "Práticas" },
