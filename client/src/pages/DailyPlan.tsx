...
import { Calendar, ChevronRight, Flame, BarChart2, CheckCircle2, Circle } from "lucide-react";
          ...
          <div className="prayer-card p-8 mb-6 animate-fade-in relative overflow-hidden">
            ...
            <div className="mt-8 pt-6 border-t border-border/30">
              <div className="flex justify-between text-xs font-semibold text-muted-foreground mb-2">
                <span className="text-[oklch(0.22_0.07_260)]">Progresso espiritual hoje</span>
