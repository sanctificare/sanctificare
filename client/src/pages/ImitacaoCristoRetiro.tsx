...
export default function ImitacaoCristoRetiro() {
  ...
  const handleAudioEnd = () => {
    ...
    setCurrentTime(0);
    if (ambientAudioRef.current) ambientAudioRef.current.pause();
    if (selected.id === IMITACAO_PILULAS[IMITACAO_PILULAS.length - 1].id) {
  ...
  return (
    <div className="min-h-screen bg-[oklch(0.97_0.01_85)] pb-24 lg:pb-12 relative overflow-hidden">
      ...
      <main className="container py-7 relative z-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-5 gap-4">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {selected.id === IMITACAO_PILULAS[IMITACAO_PILULAS.length - 1].id && (
              <Button
                            ...
                            <div className="flex items-center justify-between px-2">
                              ...
                              <div className="flex items-center gap-3">
                                <button
                                  ...
                                  className="text-slate-300 hover:text-white w-9 h-9 rounded-full hover:bg-white/5 flex items-center justify-center transition-colors cursor-pointer"
                                ...
                                <button
                                  onClick={togglePlay}
                                  className="w-12 h-12 rounded-full bg-gradient-to-tr from-amber-500 to-amber-400 hover:from-amber-400 hover:to-amber-300 text-slate-950 flex items-center justify-center shadow-lg shadow-amber-500/20 transition-all hover:scale-105 active:scale-95 cursor-pointer"
      ...
      <QuoteCardModal
        ...
        bookTitle="A Imitação de Cristo"
      ...
      <RetiroCompletionModal
        ...
        bookTitle="A Imitação de Cristo"
        author="Tomás de Kempis"
        totalDays={IMITACAO_PILULAS.length}
      />
    </div>
  );
}
