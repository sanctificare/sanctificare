...
import { Play, Lock, Crown, Clock, Film, Video, AlertCircle, Search, X, Share2 } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-[oklch(0.97_0.01_85)]">
      ...
      <UpgradeDialog
        ...
        description="Este vídeo e outras produções exclusivas estão disponíveis apenas para assinantes Premium."
      />
    </div>
  );
}
