...
export const dailyRoutine: PrayerCatalogItem[] = [
  {
    ...
    duration: "15-20 min",
    cover: "/assets/dashboard/rosario.webp",
    accent: "bg-[oklch(0.55_0.14_15/0.1)] text-[oklch(0.55_0.14_15)] dark:text-rose-300",
  ...
  },
  {
    ...
    speaker: "Equipe Sanctificare",
    duration: "5-8 min",
    cover: "/assets/dashboard/lectio.webp",
  ...
  },
  {
    ...
    speaker: "Equipe Sanctificare",
    duration: "3-5 min",
    cover: "/assets/dashboard/oracoes.webp",
    accent: "bg-[oklch(0.40_0.10_260/0.1)] text-[oklch(0.40_0.10_260)] dark:text-sky-300",
  ...
  },
  {
    ...
    speaker: "Equipe Sanctificare",
    duration: "2 min",
    cover: "/assets/dashboard/quando-deus-fala.webp",
    accent: "bg-[oklch(0.45_0.12_200/0.1)] text-[oklch(0.45_0.12_200)] dark:text-cyan-300",
...
export const trendingPrayers: PrayerCatalogItem[] = [
  {
    ...
    cover: "/assets/dashboard/intencoes.webp",
  ...
  },
  {
    ...
    duration: "25 min",
    cover: "/assets/dashboard/via-sacra.webp",
  ...
  },
  {
    ...
    duration: "60 min",
    cover: "/assets/dashboard/musica-sacra.webp",
  ...
  },
  {
    ...
    speaker: "Equipe Sanctificare",
    duration: "1 min",
    cover: "/assets/dashboard/vela-virtual.webp",
