...
export const SACRED_MUSIC_COLLECTIONS: AudioCollection[] = [
  {
    ...
    tracks: [
      ...
      },
      {
        ...
        title: "Miserere No.1",
        description:
          "Page 1 of 1 — Composer: Manoel Dias de Oliveira e Performer: Coro Vox brasiliensis. Uma interpretação contemplativa do Miserere, para meditação e penitência profunda.",
        reference: "Miserere",
        composer: "Manoel Dias de Oliveira",
        durationSec: 330,
        narrator: "Coro Vox brasiliensis",
        status: "ready",
