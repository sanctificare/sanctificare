  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-4 right-4 z-50 p-2 rounded-lg text-white hover:bg-[oklch(0.18_0.04_260/0.5)] transition-colors"
        aria-label="Menu"
      >
      ...
      {/* Dropdown menu */}
      {isOpen && (
        <div className="fixed top-14 right-4 z-50 w-48 rounded-lg bg-[oklch(0.12_0.03_260/0.96)] border border-[oklch(0.75_0.12_75/0.25)] shadow-lg backdrop-blur-xl overflow-hidden">
          <button
